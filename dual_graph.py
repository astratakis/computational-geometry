from algorithms import triangle_face_contains_point
...
class DualGraph:
    ...
    def find_adjacent_faces(face):
        ...
        tmp_edge = face.outer_component
        while True:
            if tmp_edge.twin.incident_face.outer_component is not None:  # if adjacent face is not unbounded face
                adjacent_faces.add(tmp_edge.twin.incident_face)
            tmp_edge = tmp_edge.next
            if tmp_edge is face.outer_component:
                break
